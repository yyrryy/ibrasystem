...
urlpatterns = [
    ...
    path('changeclientfacture', views.changeclientfacture, name='changeclientfacture'),
    path('updatemodebl', views.updatemodebl, name='updatemodebl'),
    path('getpdctins', views.getpdctins, name='getpdctins'),
    path('getpdctouts', views.getpdctouts, name='getpdctouts'),
    path('exceljachdate', views.exceljachdate, name='exceljachdate'),
    path('exceljvdate', views.exceljvdate, name='exceljvdate'),
    path('exceljachfcdate', views.exceljachfcdate, name='exceljachfcdate'),
    path('exceljvfcdate', views.exceljvfcdate, name='exceljvfcdate'),
    ...
    path('facturedetailscopy', views.facturedetailscopy, name='facturedetailscopy'),
    #path('listfacturescopy', views.listfacturescopy, name='listfacturescopy'),
    #path('listfacturescopy', views.listfacturescopy, name='listfacturescopy'),
    #path('laodreglfc', views.laodreglfc, name='laodreglfc'),
    #path('laodreglfc', views.laodreglfc, name='laodreglfc'),
